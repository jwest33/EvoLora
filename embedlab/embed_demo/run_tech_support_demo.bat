...
if not exist "evolution_runs\tech_support_demo" mkdir "evolution_runs\tech_support_demo"

REM Run the evolution with moderate settings for demo
...
echo ========================================
echo Results saved to: evolution_runs\tech_support_demo\
echo.
